...
----------------------------------------------------------------------------
Config.OnlyAutoParkWhenEngineIsOff = true  -- Default false, if true auto park only when vehicle engine is off.
----------------------------------------------------------------------------
...
Config.Vehicles = {
    ...
    { model = 'rhapsody',        name = 'Rhapsody',                      brand = 'Declasse',        price = 10000, },
    { model = 'brioso2',         name = 'Brioso 300',                    brand = 'Grotti',          price = 12000, },
    { model = 'weevil',          name = 'Weevil',                        brand = 'BF',              price = 9000,  },
    { model = 'issi7',           name = 'Issi Sport',                    brand = 'Weeny',           price = 100000,},
    { model = 'blista2',         name = 'Blista Compact',                brand = 'Dinka',           price = 18950, },
    { model = 'blista3',         name = 'Blista Go Go Monkey',           brand = 'Dinka',           price = 15000, },
    { model = 'brioso3',         name = 'Brioso 300 Widebody',           brand = 'Grotti',          price = 125000,},
    { model = 'boor',            name = 'Boor',                          brand = 'Karin',           price = 23000, },
