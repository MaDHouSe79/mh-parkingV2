...
-- Target Script
Config.TargetScript = "ox_target" -- Default qb-target but you can also use ox_target.

-- Fuel Script
Config.FuelScript = 'mh-fuel'     -- Default is LegacyFuel, if you use a other fuel script, for example cc-fuel

-- Notify Script
Config.DisableParkNotify = true   -- Default true, if false you get many notifications when you enter or leave the vehicle, all other notify massages are stil enable.
Config.NotifyScript = "k5_notify" -- Default qb, but you can use this scripts aswell (k5_notify, okokNotify, Roda_Notifications)
